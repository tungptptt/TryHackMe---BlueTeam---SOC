# 1. Junior Security Analyst Intro
  ## a. Junior Security Analyst Journey  
  - Needing defenders who analyze attacks, stop breaches, and keep companies safe.
  - Everyday you protect your company from appearing in the cyber news
  - Working in a 24/7 SOC team and mostly reviewing the security alerts together with the team. 
  - Needing practice and skills learned : 
      - Monitor and investigate various security alerts
      - Participate in SOC brainstorms and workshops
      - Cooperate with other teams to keep company safe
      - Constantly learn and discover new attacks and defenses

 ## b. Security Operations Center (SOC)
 - Being not alone in monitoring the alerts and securing the whole company. A lot of people support you in your job.
 - Roles 
   - SOC engineers are configuring the security tools
   - Senior analysts are helping with complex attacks  
   - SOC manager is trying to keep everything under control
   - Incident Responder is being called on demand during major incidents.
 - Daily duties:
